...
namespace EmpireDesAmis\Country\Infrastructure\Symfony\Command;

use EmpireDesAmis\Country\Application\Command\CreateCountryCommand;
...
{
    private const string PATH_FILE_TO_COUNTRY = '/assets/files/countries.csv';
